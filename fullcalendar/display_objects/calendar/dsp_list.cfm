...
<cfif variables.iterator.getRecordcount()>
	<cfoutput>
	<cfset $.addToHTMLHeadQueue('#$.siteConfig('themeAssetPath')#/display_objects/calendar/css-include.cfm')>
	<cfset $.addToHTMLFootQueue('#$.siteConfig('themeAssetPath')#/display_objects/calendar/js-include.cfm')>
		<cfsilent>
		...
		#variables.$.dspObject_Include(thefile='dsp_full_calendar.cfm',
